...
# Title: LimeSDR CCSDS Transmission
# Author: diego
...
import limesdr_tx_ccsds_yamcs_epy_block_0 as epy_block_0  # embedded python block
import limesdr_tx_ccsds_yamcs_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class limesdr_tx_ccsds_yamcs(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LimeSDR CCSDS Transmission", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LimeSDR CCSDS Transmission")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "limesdr_tx_ccsds_yamcs")
...
def main(top_block_cls=limesdr_tx_ccsds_yamcs, options=None):
