...
# Title: LimeSDR CCSDS Transmission (UDP)
# Author: diego
...
import limesdr_tx_ccsds_udp_epy_block_0 as epy_block_0  # embedded python block
import limesdr_tx_ccsds_udp_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class limesdr_tx_ccsds_udp(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "LimeSDR CCSDS Transmission (UDP)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("LimeSDR CCSDS Transmission (UDP)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "limesdr_tx_ccsds_udp")
        ...
        self._tx_gain_range = qtgui.Range(-12, 64, 1, 20, 200)
        ...
        self.network_socket_pdu_0 = network.socket_pdu('UDP_SERVER', '127.0.0.1', '1234', 10000, False)
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.soapy_limesdr_sink_0, 0))
...
def main(top_block_cls=limesdr_tx_ccsds_udp, options=None):
