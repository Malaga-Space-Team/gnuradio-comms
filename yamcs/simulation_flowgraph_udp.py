...
# Title: CCSDS -> Yamcs Flowgraph (UDP)
# Author: Diego
...
import simulation_flowgraph_udp_epy_block_0 as epy_block_0  # embedded python block
import simulation_flowgraph_udp_epy_block_1 as epy_block_1  # embedded python block
import sip
import threading



class simulation_flowgraph_udp(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "CCSDS -> Yamcs Flowgraph (UDP)", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("CCSDS -> Yamcs Flowgraph (UDP)")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "simulation_flowgraph_udp")
        ...
        self.network_socket_pdu_1 = network.socket_pdu('UDP_SERVER', '127.0.0.1', '1234', 10000, False)
        ...
        self.msg_connect((self.network_socket_pdu_1, 'pdus'), (self.epy_block_1, 'in'))
...
def main(top_block_cls=simulation_flowgraph_udp, options=None):
